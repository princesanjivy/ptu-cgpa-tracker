                ...
                children: <Widget>[
                  Padding(
                      padding: EdgeInsets.only(
                          top: 50, bottom: 20, left: 30, right: 25),
                      child: Container(
                        height: 230,
                        width: 320,
                        child: Card(
                        ...
                        child: Card(
                          ...
                          child: Column(children: <Widget>[
                            ...
                            Padding(
                                ...
                                child: Text.rich(TextSpan(
                                    text:
                                        '" A lifelong learner and self thought ',
                                    style: GoogleFonts.poppins(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w400,
                                      color: Colors.white,
                        ...
                        child: Card(
                          ...
                          child: Column(children: <Widget>[
                            ...
                            Padding(
                                ...
                                child: Text.rich(TextSpan(
                                    text:
                                        '" A Intermediate Web Developer AND ,',
                                    style: GoogleFonts.poppins(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w400,
                                      color: Colors.white,
